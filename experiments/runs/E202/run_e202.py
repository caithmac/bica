"""E202 — Fine-Tuning Sweep. MLP depth + dropout ablation on ESM-2 features."""
...
# Configs: varying MLP depth/dropout as proxy for "finetuning capacity"
CONFIGS = [
...
for cfg in CONFIGS:
    for seed in SEEDS:
        ...
        results.append({**cfg, "seed": seed, "rmse": rmse, "pearson_r": r,
